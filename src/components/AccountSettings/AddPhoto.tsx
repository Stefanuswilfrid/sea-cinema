...
export default function AddPhoto({id}:{id:string}) {
  ...
  />
    ...
    {/* <button className="absolute bottom-[-5px] left-1/2 transform -translate-x-1/2 block p-[0.375rem] px-4 rounded-full bg-white shadow-custom transition-transform duration-300 ease-in-out active:scale-90">
